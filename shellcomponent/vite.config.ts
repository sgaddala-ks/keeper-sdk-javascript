...
export default defineConfig(({ command, mode }) => {
  ...
  return {
    root: ".",
    plugins: isServe ? [keeperDevSessionConfPlugin(), keeperSameOriginProxyPlugin()] : [],
    resolve: {
      alias: {
        // Bundle from KeeperSdk sources (CJS dist/browser.js breaks Rollup named exports).
        "@keeper-security/keeper-sdk-javascript": resolve(
          __dirname,
          "../KeeperSdk/src/browser.ts"
        ),
