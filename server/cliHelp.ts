...
const CLI_COMMANDS: CliHelpEntry[] = [
  ...
  },
  {
    ...
    description: "Create a directory under CLI_DATA_DIR (or process cwd); relative paths only; `--` ends options.",
  },
  {
    name: "records",
  ...
  },
  {
    ...
    description:
      "Store device token + private key for this host so session-token login works (see login --help).",
  },
